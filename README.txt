...
InSpec profile overlay to validate the secure configuration of AWS RDS
Infrastructure against the
[CIS's](https://www.cisecurity.org/cis-benchmarks/) Amazon Web Services
Three-tier Web Architecture Benchmark v1.2.0 tailored for [CMS ARS
...
[issue](https://github.cms.gov/ispg/cms-ars-3.1-moderate-aws-rds-infrastructure-cis-overlay/issues/new).
